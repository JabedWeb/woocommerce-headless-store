          ...
          <tbody>
            {currentOrders.map(order => (
              <tr key={order.id}>
                ...
                <td className="border-b px-4 py-2">{order.billing.first_name} {order.billing.last_name}</td>
      ...
      {selectedOrder && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-white rounded shadow-lg p-4 max-w-lg w-full">
            <h3 className="text-lg font-bold mb-4">Order Details (ID: {selectedOrder.id})</h3>
